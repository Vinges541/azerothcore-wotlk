...
enum PlayerbotsDatabaseStatements : uint32
{
    ...
    */
    ...
    PLAYERBOTS_SEL_GUILD_TASK_ITEM_EXPIRY,
    PLAYERBOTS_SEL_GUILD_TASKS_BY_OWNER,
    PLAYERBOTS_UPD_GUILD_KILL_TASK_COMPLETE,
    PLAYERBOTS_INS_GUILD_KILL_CLAIM,
    PLAYERBOTS_SEL_GUILD_KILL_CLAIM,
    PLAYERBOTS_SEL_GUILD_KILL_CLAIM_PAGE,
    PLAYERBOTS_UPD_GUILD_KILL_CLAIM_APPLY,
    PLAYERBOTS_DEL_GUILD_KILL_CLAIM_RETIRED,
    PLAYERBOTS_SEL_GUILD_KILL_TASK_PAGE,
    PLAYERBOTS_LOCK_GUILD_ITEM_TASK,
    PLAYERBOTS_UPD_GUILD_ITEM_TASK_COMPLETE,
    PLAYERBOTS_UPD_GUILD_ITEM_TASK_PROGRESS,
    PLAYERBOTS_INS_GUILD_MAIL_CONTRIBUTION,
    PLAYERBOTS_UPD_GUILD_MAIL_CONTRIBUTION_APPLY,
    PLAYERBOTS_SEL_GUILD_MAIL_TASK_SNAPSHOT,
    PLAYERBOTS_UPD_GUILD_MAIL_CONTRIBUTION_REJECT,
    PLAYERBOTS_SEL_GUILD_MAIL_CONTRIBUTION,
    PLAYERBOTS_SEL_GUILD_MAIL_CONTRIBUTION_PAGE,
    ...
    PLAYERBOTS_DEL_ALL_GUILD_TASKS,
